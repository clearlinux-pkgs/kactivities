...
Version  : 5.107.0
Release  : 66
URL      : https://download.kde.org/stable/frameworks/5.107/kactivities-5.107.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.107/kactivities-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/kactivities-5.107.0.tar.xz.sig
...
%prep
%setup -q -n kactivities-5.107.0
cd %{_builddir}/kactivities-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686539271
mkdir -p clr-build
pushd clr-build
