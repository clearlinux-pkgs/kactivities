...
Source0  : https://download.kde.org/stable/frameworks/5.68/kactivities-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/kactivities-5.68.0.tar.xz.sig
...
%prep
%setup -q -n kactivities-5.68.0
cd %{_builddir}/kactivities-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584311824
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kactivities-5.68.0/COPYING %{buildroot}/usr/share/package-licenses/kactivities/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kactivities-5.68.0/COPYING.LGPL-2 %{buildroot}/usr/share/package-licenses/kactivities/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/kactivities-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kactivities/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Activities.so.5.68.0
