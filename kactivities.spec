...
Source0  : https://download.kde.org/stable/frameworks/5.114/kactivities-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/kactivities-5.114.0.tar.xz.sig
...
%prep
%setup -q -n kactivities-5.114.0
cd %{_builddir}/kactivities-5.114.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705448695
mkdir -p clr-build
pushd clr-build
